...
Once Node.js and npm are installed download and unzip the CTK-TMF651-AgreementManagement ZIP file within your test directory.
...
>http://tm-forum-open-api-reference-implementation.mybluemix.net:80/tmf-api/agreementManagement/v2/agreement

You should input:
>>http://tm-forum-open-api-reference-implementation.mybluemix.net:80/tmf-api/agreementManagement/v2/
...
![CTK Example Image](https://github.com/tmforum-rand/CTK-TMF651-AgreementManagement/blob/master/CTK-TMF651-AgreementManagement/Output-Example.png)
