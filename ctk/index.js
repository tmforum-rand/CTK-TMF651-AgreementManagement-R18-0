...
var DefaultURL = "http://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/agreementManagement/v2/";
var schema;
var hostname;
var port;
var APIRelativeAddress;
var statusCode;
const exampleEndPoint = "agreement";
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout
});

console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF651 AgreementManagement\n");
getURL();
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF651-AgreementManagement.postman_collection.json'),
